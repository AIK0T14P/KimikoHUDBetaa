...
local Languages = {
    ["English"] = {
        ...
        features = {
            Volar = "Volar",
            Velocidad = "Velocidad",
            SuperSalto = "Super Salto",
            SaltoInfinito = "Salto Infinito",
            NoClip = "Sin Clip",
            ModoDios = "Modo Dios",
            AuraMortal = "Aura Mortal",
            ParadaAutomática = "Parada Automática",
            Alcance = "Alcance",
            ESP = "ESP",
            Chams = "Chams",
            Trazadores = "Trazadores",
            TotalmenteIluminado = "Totalmente Iluminado",
            Invisibilidad = "Invisibilidad",
            AntiAFK = "Anti AFK",
            ReinicioAutomático = "Reinicio Automático",
            EliminarNiebla = "Eliminar Niebla",
            DiaNoche = "Día/Noche",
            EliminarTexturas = "Eliminar Texturas",
            SpamDeChat = "Spam de Chat",
            AutoGranja = "Auto Granja",
            SaltoDeServidor = "Salto de Servidor",
            Idioma = "Idioma",
            GráficosBajos = "Gráficos Bajos",
            DesactivarEfectos = "Desactivar Efectos",
            ReducirTexturas = "Reducir Texturas",
            DesactivarIluminación = "Desactivar Iluminación",
            GuardarRespawn = "Guardar Respawn",
            EliminarRespawn = "Eliminar Respawn",
            GuardarPosición = "Guardar Posición",
            TeletransportarseAPosición = "Teletransportarse a Posición",
            Saltar = "Saltar",
            Dash = "Dash",
            Agacharse = "Agacharse",
            EscalarPared = "Escalar Pared",
            SaltoAéreo = "Salto Aéreo",
            Planeo = "Planeo",
            Teletransportarse = "Teletransportarse",
            EsquivaAutomática = "Esquiva Automática",
            ApuntarAutomático = "Apuntar Automático",
            FuegoRápido = "Fuego Rápido",
            MuniciónInfinita = "Munición Infinita",
            MultiplicadorDeDaño = "Multiplicador de Daño",
            BloqueoAutomático = "Bloqueo Automático",
            GolpeCrítico = "Golpe Crítico",
            Aimbot = "Aimbot",
            ApuntarSilencioso = "Apuntar Silencioso",
            TraspasarPared = "Traspasar Pared",
            MuerteInstantánea = "Muerte Instantánea",
            CuraciónAutomática = "Curación Automática",
            Triggerbot = "Triggerbot",
            BunnyHop = "Bunny Hop",
            SpinBot = "Spin Bot",
            AntiApuntar = "Anti Apuntar",
            ExpansorDeHitbox = "Expansor de Hitbox",
            ModificacionesDeArmas = "Modificaciones de Armas",
            RecargaAutomática = "Recarga Automática",
            CombateCuerpoACuerpoRápido = "Combate Cuerpo a Cuerpo Rápido"
        },
        loading = "Loading..."
    },
    ["Español"] = {
